...
import { badRequest, notFound, ok, parsePositiveInteger, serverError } from '@/utils/api';
...
export async function GET(_request: NextRequest, { params }: EventThemeRouteContext) {
