      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-base text-slate-500 max-w-2xl mx-auto">
            슬라이더를 좌우로 움직이며 실시간 HSL 값의 변화와 명암 팔레트 생성
            결과를 직관적으로 감상해보세요.
          </p>
        </div>
            ...
            <div className="lg:col-span-2 flex flex-col justify-center space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-slate-500 leading-normal">
                  💡 디자인 단일 톤의 일관성을 극대화하기 위해 **채도(S)는
                  85%**, **명도(L)는 50%**로 고정되어 있습니다. 슬라이더를 통해
                  가장 어울리는 브랜드 색상 톤(Hue)을 탐색해 보세요.
                </p>
              </div>
            </div>
        ...
        <div className="bg-white border border-slate-200/60 rounded-3xl p-6 md:p-8 shadow-sm space-y-6">
          ...
          <p className="text-xs text-slate-500">
            아래 컴포넌트들은 인라인 style이나 React 마우스 핸들러 없이, 오직
            상단 <code>&lt;style&gt;</code> 태그에 주입된 클래스명으로 일괄
            제어됩니다.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            ...
            <div className="bg-slate-50 border border-slate-200/40 rounded-2xl p-5 space-y-4">
              ...
              <div className="space-y-3">
                {/* 메인 프라이머리 테마 버튼 */}
                <button className="themed-btn-primary w-full py-3.5 rounded-xl font-bold text-white shadow-md">
                  시작하기 (themed-btn-primary)
                </button>

                {/* 서브 아웃라인 테마 버튼 */}
                <button className="themed-btn-outline w-full py-3.5 rounded-xl font-bold border">
            ...
            <div className="bg-slate-50 border border-slate-200/40 rounded-2xl p-5 space-y-4">
              ...
              <div className="space-y-3">
                {/* 배지 라인업 */}
                <div className="flex gap-2">
                  <span className="themed-badge-light px-3 py-1.5 rounded-full text-xs font-extrabold border">
                    진행 중인 이벤트
                  </span>

                  <span className="themed-badge-filled px-3 py-1.5 rounded-full text-xs font-extrabold">
                    NEW
                  </span>
                </div>

                {/* 리스트 아이템 활성화 상태 예시 */}
                <div className="themed-list-item-active p-3.5 rounded-xl border flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span className="themed-list-item-active-bullet w-2.5 h-2.5 rounded-full shrink-0 animate-pulse" />
                    <span className="themed-list-item-active-text text-sm font-semibold">
                      미션 완료: 스탬프 찍기
                    </span>
                  </div>
                  <span className="themed-list-item-active-points text-xs font-bold">
                    + 100P
                  </span>
                </div>
              </div>
